...
LOG_DIR = os.path.join(ROOT_DIR, 'federated', 'logfiles')
...
fileHandler = logging.FileHandler(
    os.path.join(LOG_DIR, f'{datetime.now().strftime("%m-%d-%Y_%H-%M-%S")}.log'), 'a', 'utf-8')
...
FLOWER_LOGGER.addHandler(fileHandler)
